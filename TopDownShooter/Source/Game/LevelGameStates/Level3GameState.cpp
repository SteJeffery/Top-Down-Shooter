...
#include "../LevelGameStates/Level4GameState.h"
...
//////////////////////////////
Level3GameState::Level3GameState():GameState()
{
}
...
//////////////////////////////
Level3GameState::~Level3GameState()
{
}
...
//////////////////////////////
void Level3GameState::Initialise()
{
	...
	m_pTileMapBase->LoadFromSpriteSheetDef(pSpriteSheetDef, levelbase3, 56, 22);
	m_GameObjects.push_back(m_pTileMapBase);

	TileMap* pForeground = new TileMap();
	pForeground->Initialise();
	pForeground->LoadFromFile("levels/Level3.txt");
...
{	
	...
	if (pGameDataStorage->m_Score == 120)
	{
		GameStateManager* pGameStateManager = C_SysContext::Get<GameStateManager>();
		Level4GameState* pLevel4 = new Level4GameState();
		pGameStateManager->QueueGameState(pLevel4);
	}
}
...
//////////////////////////////
GameObject* Level3GameState::GetPlayer()
{
