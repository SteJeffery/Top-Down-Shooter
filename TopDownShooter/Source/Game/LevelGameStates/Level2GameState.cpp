...
#include "../LevelGameStates/Level3GameState.h"
...
//////////////////////////////
Level2GameState::Level2GameState():GameState()
{
}
...
//////////////////////////////
Level2GameState::~Level2GameState()
{
}
...
//////////////////////////////
void Level2GameState::Initialise()
{
	...
	m_pTileMapBase->LoadFromSpriteSheetDef(pSpriteSheetDef, levelbase2, 64, 64);
	m_GameObjects.push_back(m_pTileMapBase);

	TileMap* pForeground = new TileMap();
	pForeground->Initialise();
	pForeground->LoadFromFile("levels/Level2.txt");
...
{	
	...
	if (pGameDataStorage->m_Score == 80)
	{
		GameStateManager* pGameStateManager = C_SysContext::Get<GameStateManager>();
		Level3GameState* pLevel3 = new Level3GameState();
		pGameStateManager->QueueGameState(pLevel3);
	}
}
...
//////////////////////////////
GameObject* Level2GameState::GetPlayer()
{
