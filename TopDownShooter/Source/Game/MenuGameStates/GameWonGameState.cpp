...
//////////////////////////////
GameWonGameState::GameWonGameState():GameState()
{
}
...
//////////////////////////////
GameWonGameState::~GameWonGameState()
{
	m_GameObjects.clear();
}
...
//////////////////////////////
void GameWonGameState::Initialise()
{
	
	UISprite* t_SGO = new UISprite();
	t_SGO->setSprite("backgrounds/bg_end.png");
	t_SGO->setScale(0.7, 0.75);
	t_SGO->SetPosition(-150, 0);
	t_SGO->Initialise();
...
void GameWonGameState::Update()
{
	...
	if (m_currentReturnKeyPressed && !m_prevReturnKeyPressed && selection == 0)
	{
		...
		MainMenuGameState* pMenu = new MainMenuGameState();
		pGameStateManager->QueueGameState(pMenu);
...
GameObject * GameWonGameState::GetPlayer()
{
	return nullptr;
}
